...
Filter to only keep combinations where at least three samples had at least six cells expressing that particular combination of markers. 

This is based on the original COMPASS Category Filter.
