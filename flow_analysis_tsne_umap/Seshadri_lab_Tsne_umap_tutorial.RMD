...
The .xml and .fcs files for this dataset are stored in the Seshadri Lab shared drive (LSR Fortessa/2021 Summer HAARVIVAC/20210902 HAARVIVAC Batch 4/). Download the .xml file and folder containing the .fcs files and drag into the "data" folder of this project directory. Make sure the folder is unzipped (Google Drive may zip it when you download) and note that this is a large folder (1.8 GB).
